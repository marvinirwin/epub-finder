    ...
    _createClass(Track, [
        {
            ...
            value: function gain(_gain) {
                return new Track(
                    this.fragments.map(function (fragment) {
        ...
        },
        {
            ...
            value: function pitch(rate) {
                return new Track(
                    this.fragments.map(function (fragment) {
                        return fragment.clone({
                            pitch: fragment.pitch * rate,
                            stretch: false,
                        })
                    }),
                    0,
                ) // need to recalculate the duration
            },
        },
        {
            key: 'stretch',
