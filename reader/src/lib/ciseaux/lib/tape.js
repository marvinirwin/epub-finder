...
var Tape = (function () {
    _createClass(Tape, null, [
        ...
        },
        {
            ...
            value: function concat() {
                ...
                return (_ref = new Tape(1, config.sampleRate)).concat.apply(
                    _ref,
                    arguments,
                )
            },
        },
        {
            ...
            value: function mix() {
                ...
                var newInstance = (_ref2 = new Tape(
                    1,
                    config.sampleRate,
                )).mix.apply(_ref2, arguments)
    ...
    _createClass(Tape, [
        ...
        },
        {
            ...
            value: function concat() {
                for (
                    var _len = arguments.length, tapes = Array(_len), _key = 0;
                    _key < _len;
                    _key++
                ) {
                ...
                tapes.forEach(function (tape) {
                    ...
                    if (newInstance.numberOfTracks < tape.numberOfTracks) {
                        newInstance = util.adjustNumberOfTracks(
                            newInstance,
                            tape.numberOfTracks,
                        )
                    }
                    if (tape.numberOfTracks < newInstance.numberOfTracks) {
                        tape = util.adjustNumberOfTracks(
                            tape,
                            newInstance.numberOfTracks,
                        )
                    }
        ...
        },
        {
            ...
            value: function loop() {
                ...
                return new Tape(this.numberOfChannels, this.sampleRate).concat(
                    tapes,
                )
            },
        },
        ...
        },
        {
            ...
            value: function replace() {
                ...
                return this.slice(0, beginTime).concat(
                    tape,
                    this.slice(beginTime + duration),
                )
            },
        },
        {
            ...
            value: function mix() {
                ...
                tapes.forEach(function (tape) {
                    ...
                    if (newInstance.duration < tape.duration) {
                        newInstance = util.adjustDuration(
                            newInstance,
                            tape.duration,
                            method,
                        )
        ...
        },
        {
            ...
            value: function render() {
                if (config.render) {
                    ...
                    return config.render.apply(
                        config,
                        [this.toJSON()].concat(args),
                    )
                }
...
var TransferredTape = (function (_Tape) {
    ...
    function TransferredTape(audiodata) {
        ...
        var _this = _possibleConstructorReturn(
            this,
            Object.getPrototypeOf(TransferredTape).call(
                this,
                AudioData.getNumberOfChannels(audiodata),
