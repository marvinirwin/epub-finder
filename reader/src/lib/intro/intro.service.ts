...
export const SKIP_INTRO = new URLSearchParams(window.location.search).has(
  "skip_intro"
);
...
export class IntroService {
  ...
  constructor({
    ...
    firstIntro$.subscribe(
      async ([titleRef, readingFrameRef, trySpeakingRef, watchSentenceRef]) => {
        return;
