...
export const languageRegexMap = new Map<LanguageCode, {strategy?: WordIdentifyingStrategy, regexp: RegExp}>(flatten(LanguageSeparatorStrategy.map(({languages, strategy, regexp}) =>
