                    ...
                    return [
                        sum(
                            Object.entries(weightedWords)
                                .filter(
                                    ([word, weight]) => !missingWords.has(word),
                                )
                                .map(([word, weight]) => weight),
                        ),
                        sum(
                            Object.values(weightedWords).map(
                                ([word, weight]) => weight,
                            ),
                        ),
                    ]
