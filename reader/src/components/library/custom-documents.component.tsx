...
export const CustomDocumentsComponent: React.FunctionComponent<{
        ...
        <Paper>
            <div>
                ...
                <TextField
                    label=""
                    onChange={(ev) =>
                        editingDocument.name$.next(ev.target.value)
                    }
                    value={rawName}
                />
            </div>
            <textarea
                onChange={(e) => editingDocument.text$.next(e.target.value)}
                value={rawText}
            />
        </Paper>
    )
