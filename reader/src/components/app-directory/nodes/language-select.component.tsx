    ...
    <Fragment>
      <Box m={2}>
        ...
        <Select
          ...
          onChange={(e) =>
            m.settingsService.readingLanguage$.next(e.target.value as string)
          }
          inputProps={{
            className: readingLanguageSelect,
          }}
        >
          {SupportedTranslationService.SupportedTranslations.map((c) => (
      ...
      <Box m={2}>
        ...
        <Select
          ...
          onChange={(e) =>
            m.settingsService.spokenLanguage$.next(e.target.value as string)
          }
          inputProps={{
