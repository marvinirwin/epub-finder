...
export class PronunciationSection {
    ...
    timeBarFraction(): number | undefined {
        ...
        if (!videoTimeMs || this.timeBarSectionIndex() !== this.c.lineIndex)
            return undefined
    ...
    highlightBarPoints(): number[] | undefined {
        ...
        if (start !== undefined && end !== undefined) {
            ...
            return boundedPoints(ordered[0], ordered[1], 0, 1)
        }
    }
    ...
    private timeBarSectionIndex(): number | undefined {
        return (
            this.c.videoTimeMs &&
            Math.floor(this.c.videoTimeMs / this.c.sectionLengthMs)
        )
    }
