...
import {DeltaScan, ds_Dict, flattenTree} from "../lib/Util/DeltaScanner";
import {Observable} from "rxjs";
import {map} from "rxjs/operators";
import {Named} from "../lib/Manager/OpenBooks";
...
export const constructTree = <T>(t: TreeConstructor<T>): ds_Tree<T> => {
    ...
    return {
        ...
        children: Object.fromEntries(
            children.map(constructor => [constructor[1], constructTree(constructor)])
        )
    };
}